...
"about_me": {
    "name": "about_me",
    "type": "file",
    "content": '<hr class="line"> <div style="color: white;"> <h1>About me</h1> <p class="text_disk_bottom text_disk">Hi, I&apos;m Samuel Fischer, a passionate developer from Italy who thrives on solving complex problems and creating innovative solutions. Ever since I started coding, I&apos;ve been fascinated by the intersection of hardware and software, always looking for ways to blend the two seamlessly.</p> <p class="text_disk_bottom text_disk">I believe that "My life is an application, and I am the Developer". This mindset drives me to continuously improve, learn new technologies, and build projects that push the boundaries of what&apos;s possible. Whether it&apos;s designing embedded systems, experimenting with open-source software, or developing custom hardware solutions, I enjoy the challenge of turning ideas into reality.</p> <p class="text_disk">When I&apos;m not coding, you&apos;ll probably find me exploring new tech trends, tinkering with electronics, or diving into creative side projects. I&apos;m always open to collaborations and new opportunities, so feel free to reach out!</p> </div> <hr class="line">'
}
}